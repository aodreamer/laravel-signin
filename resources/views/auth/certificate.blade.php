...
<div class="container mt-5">
    ...
    @if ($certificate)
        <div class="row justify-content-center">
            ...
            <div class="col-md-4">
                <form id="submitForm" method="POST" action="{{ route('cert.request') }}">
                    @csrf
                    <button type="button" class="btn btn-primary btn-lg btn-block" onclick="showSubmitRequestPopup()">Ajukan Perubahan</button>
                </form>
            </div>
        </div>
    @else
