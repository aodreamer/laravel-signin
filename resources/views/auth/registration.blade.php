...
<style>
    ...
    .login-box .user-box input {
        ...
        -webkit-text-fill-color: black; /* Set the text color for auto-filled fields */
    }
...
<main class="signup-form">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="login-box">
                    <h3 class="card-header text-center" style="color: white;">Register User</h3>
                    <div class="card-body">
                        <form action="{{ route('register.custom') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                <label style="margin-bottom: 10px;">Role</label>
